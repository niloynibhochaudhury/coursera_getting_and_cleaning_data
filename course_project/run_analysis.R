...
rm(feature_names) ## free up memory by removing data that is no longer needed
...
rm(column_index) ## free up memory by removing data that is no longer needed
rm(features) ## free up memory by removing data that is no longer needed
rm(feature_names2) ## free up memory by removing data that is no longer needed
...
rm(activity_labels) ## free up memory by removing data that is no longer needed
rm(merged_data) ## free up memory by removing data that is no longer needed
rm(merged_data2) ## free up memory by removing data that is no longer needed
rm(table_merged_data) ## free up memory by removing data that is no longer needed
